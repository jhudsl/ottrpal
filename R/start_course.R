#' Starting a Course, Light wrapper for \code{\link{check_structure}}
#'
...
#' @return The output of \code{\link{check_structure}}.
#' @export
#' @examples
#' root_path = tempfile()
...
create_course = function(course_name,
  ...
  res = check_structure(course_dir = course_dir, book_txt = book_txt,
  ...
  class(res) = c("leanpub_course", class(res))
  return(res)
}
